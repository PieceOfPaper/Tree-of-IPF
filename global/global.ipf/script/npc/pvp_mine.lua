...
--         IMC_LOG('ERROR_LOGIC', 'pvp_mine_rule.xml is not exist god damn!')
...
--     end
--     else
--         if tonumber(pvp_mine_rule.StartHour) == hour then
--             if (min >= tonumber(pvp_mine_rule.FirstStartMin) and min <= tonumber(pvp_mine_rule.FirstStartMin + 5)) or(min >= tonumber(pvp_mine_rule.SecondStartMin) and min <= tonumber(pvp_mine_rule.SecondStartMin + 5)) then
--                 if pc.Lv < 350 then
--                     ShowOkDlg(pc, 'EV_PRISON_DESC2', 1)
--                     return false;
--                 elseif partyObj ~= nil then
...
--                     return true;
--                 end
--             elseif (min >= tonumber(pvp_mine_rule.FirstStartMin) + 6 and min <= tonumber(pvp_mine_rule.FirstStartMin) + 15) or(min >= tonumber(pvp_mine_rule.SecondStartMin) + 6 and min <= tonumber(pvp_mine_rule.SecondStartMin) + 15) then
--                 ShowOkDlg(pc, 'PVP_MINE_DLG5', 1)
--                 return false;
--             end
--         end
...
--         if pvp_mine_rule == nil then
--             if 21 == hour then
--                 if (min >= 10 and min <= 15) or (min >= 30 and min <= 35) then
