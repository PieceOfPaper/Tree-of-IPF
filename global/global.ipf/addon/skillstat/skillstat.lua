function REQ_SKILLSTAT_ITEM(frame, ctrl)
	...
	if argList == 'Premium_SkillReset' or argList == 'steam_Premium_SkillReset' or argList == 'Premium_SkillReset_14d' or argList == 'steam_Premium_SkillReset_1' or argList == 'Premium_SkillReset_1d' or argList == 'Premium_SkillReset_60d' or argList == 'Premium_SkillReset_Trade' then
