...
function Petrification_ENTER(actor, obj, buff)
	...
	-- actor:GetEffect():EnableVibrate(1, 0.5, 0.5, 50.0); -- ?ºÍµ¥ Íπ®Ï???Í≤??åÎ¨∏???ÑÏãúÎ°?Ï£ºÏÑù.
...
function CalcBuffEffScale(radius)
	local scale = 1;		-- Í∏∞Ï?. ?§Î™∞ m_radius = 12
...
-- ?îÎ†à?§ÎÑ§?úÏä§Ï≤òÎüº FSM?ºÎ°ú??ASTD?¥Ï?Îß??§Ï†úÎ°úÎäî ?§ÌÇ¨Ï∫êÏä§?ÖÏ§ë ?∏Í≤É???±Î°ù. (Î≤ÑÌîÑÎ°?Ï∫êÏä§?ÖÏ§ë?∏Í≤É ?ïÏù∏)
...
--Î∞òÏßù??Î≤ÑÌîÑ: ?ÄÎ∞?Î≤ÑÌîÑÏ≤òÎüº Î∞òÏßùÍ±∞Î¶¨Í∏∞Îßå ?òÎäî ?©ÎèÑ
