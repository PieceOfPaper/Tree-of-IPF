function SCR_SSN_MASTER_PSYCHOKINO1_BASIC_HOOK(self, sObj)
end

function SCR_CREATE_SSN_MASTER_PSYCHOKINO1(self, sObj)
	SCR_SSN_MASTER_PSYCHOKINO1_BASIC_HOOK(self, sObj)
end

function SCR_REENTER_SSN_MASTER_PSYCHOKINO1(self, sObj)
	SCR_SSN_MASTER_PSYCHOKINO1_BASIC_HOOK(self, sObj)
end

function SCR_DESTROY_SSN_MASTER_PSYCHOKINO1(self, sObj)
end


-- PSYCHOKINO'S BOOK in

function SCR_MASTER_PSYCHOKINO1_BOOK_1_DIALOG(self, pc)
    SCR_MASTER_PSYCHOKINO1_BOOK_RUN(self, pc, 1)
end

function SCR_MASTER_PSYCHOKINO1_BOOK_2_DIALOG(self, pc)
    SCR_MASTER_PSYCHOKINO1_BOOK_RUN(self, pc, 2)
end

function SCR_MASTER_PSYCHOKINO1_BOOK_3_DIALOG(self, pc)
    SCR_MASTER_PSYCHOKINO1_BOOK_RUN(self, pc, 3)
end

function SCR_MASTER_PSYCHOKINO1_BOOK_4_DIALOG(self, pc)
    SCR_MASTER_PSYCHOKINO1_BOOK_RUN(self, pc, 4)
end

function SCR_MASTER_PSYCHOKINO1_BOOK_5_DIALOG(self, pc)
    SCR_MASTER_PSYCHOKINO1_BOOK_RUN(self, pc, 5)
end


function SCR_MASTER_PSYCHOKINO1_BOOK_RUN(self, pc, num)
    local result1 = SCR_QUEST_CHECK(pc, 'MASTER_PSYCHOKINO1')
    if result1 == 'PROGRESS' then
        ...
        if sObj ~= nil then
            if sObj['QuestInfoValue'..num] == 0 then
                ...
                local result2 = DOTIMEACTION_R(pc, ScpArgMsg("JOB_2_PSYCHOKINO_5_1_MSG01"), 'SITREAD', animTime, 'SSN_HATE_AROUND')
