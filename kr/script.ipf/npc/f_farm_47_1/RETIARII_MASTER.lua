function SCR_RETIARII_MASTER_DIALOG(self, pc)
    ...
    elseif is_unlock == 'NO' then
        ...
        elseif hidden_Prop >= 50 and hidden_Prop <= 100 then
            ...
            if muscular_P < 40 or endurande_P < 20 or agility_P < 40 or simulation_P < 40 then
...
--                            print(#traning_Item2)
        ...
        elseif muscular_P >= 40 and endurande_P >= 20 and agility_P >= 40 and simulation_P >= 40 then
