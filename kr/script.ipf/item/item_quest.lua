...
function SCR_USE_JOB_ONMYOJI_MSTEP2_7_ITEM1(self, argObj, argstring, arg1, arg2)
    ...
    if sObj ~= nil then
        ...
        if result == 1 then
            if sObj.String5 ~= "None" then
                ...
                if table.find(string_cut_list, num) == 1 then
                    if sObj.String6 == "None" then
                        ...
                        if sObj.Goal9 < max_cnt then
                            SendAddOnMsg(self, 'NOTICE_Dm_Clear', ScpArgMsg("CHAR220_MSETP2_7_MSG2").."{nl}".."( "..sObj.Goal9.." / "..max_cnt.." "..ScpArgMsg('NumberOfThings').." )",3)
                        else
            ...
            SendAddOnMsg(self, 'NOTICE_Dm_scroll', ScpArgMsg("CHAR220_MSETP2_7_MSG3"),3)
            return
        end
    end
end
