...
function JOB_ABIL_LIST(self, jobClassName)
    ...
    for k = 1, #abilList do
        ...
        text = text .. startLine .. 'Name="' .. abilList[k].Name .. '"' .. ' ClassName="' .. abilList[k].ClassName .. '"' .. ' Desc="' .. abilList[k].Desc .. '"' .. ' AlwaysActive="' .. abilList[k].AlwaysActive .. '"' .. ' JobClassName="' .. jobCategory[k] .. '"' .. endLine;
