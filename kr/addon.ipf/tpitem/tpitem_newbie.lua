	...
	for i = 0, cnt - 1 do
        ...
        if obj.Price ~= 0 then
            ...
            if itemClassName ~= nil then
                ...
                if CHECK_NEWBIE_SHOW_ITEM(frame, obj, itemobj) == true then
...
function TPITEM_NEWBIE_DRAW_TIME_SALE_CTRL(itemobj, itemcset)
...
function TPITEM_NEWBIE_DRAW_ITEM_DETAIL(obj, itemobj, itemcset)
	...
	-- 기간 한정
	TPITEM_NEWBIE_DRAW_TIME_SALE_CTRL(itemobj, itemcset)
