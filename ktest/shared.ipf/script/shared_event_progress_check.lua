...
function GET_EVENT_PROGRESS_CHECK_ACQUIRE_STATE_MAX_VALUE(type)
    local table = 
    {
        [1] = {1000, 10, 33, 10, 100},
        [2] = {600, 2, 33, 36, 60},
        [3] = {GET_EVENT_FLEX_BOX_MAX_CONSUME_COUNT(), GET_EVENT_FLEX_BOX_DAILY_PLAY_TIME_MAX_CONSUME_COUNT(), 24, GET_EVENT_FLEX_BOX_DAILY_CONTENTS_MAX_CONSUME_COUNT(), GET_EVENT_FLEX_BOX_MAX_OPEN_COUNT()},
    }
